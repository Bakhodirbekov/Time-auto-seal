    ...
    <div class="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-gray-100">
        ...
        <form action="{{ route('login.post') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" required class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition" placeholder="admin@insofauto.uz">
            </div>
            <div>
